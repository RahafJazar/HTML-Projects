...
export default class HolidayController {
    constructor(holidayService, holidayUI, appState, toastUI) {
    ...
    async loadHolidays() {
        ...
        if (holidays) {
            ...
            this.holidayUI.renderHolidays(holidays, this.appState.getSelection().selectedCountry_["name"], this.appState.getPlans());
